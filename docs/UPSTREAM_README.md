# Cyclo Intelligence (Upstream README)

> This is the original `README.md` from [ROBOTIS-GIT/cyclo_intelligence](https://github.com/ROBOTIS-GIT/cyclo_intelligence),
> preserved here when this fork replaced the root README with the EY PhyAI Lab
> operation guide. Refer to this file when syncing with upstream.
